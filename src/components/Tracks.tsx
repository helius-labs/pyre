...
export default function Tracks({ setSelectedComponent, progress, setTrack, originalQuestions }: any) {
    ...
    return (
        <>
            ...
            <div className='flex w-full h-screen flex-col px-8 py-32 justify-evenly text-zinc-400 items-center'>
                ...
                <div className='flex flex-col xl:flex-row gap-8 xl:gap-0 px-8 py-32 justify-evenly text-zinc-400 items-center'>
                        ...
                        <div className='flex w-full h-full'>
                            ...
                            <div className='flex w-full flex-col p-6 gap-8'>
                                <div className='flex gap-2 flex-col'>
                                    <div className='text-lg xl:text-3xl font-medium truncate tracking-wider'>Compression</div>
                                    <div className="flex space-x-2 flex-row text-sm tracking-widest leading-5">
                    ...
                    <div onClick={() => { setTrack("MISCELLANEOUS") }} className={`flex w-2/3 xl:w-[35%] h-72 bg-zinc-800 text-zinc-200 justify-between items-center animate-fade animate-fade-out rounded-2xl hover:bg-zinc-700 duration-200 cursor-pointer`}>
                        <div className='flex w-full h-full'>
                            ...
                            <div className='flex w-full flex-col p-6 gap-8'>
                                <div className='flex gap-2 flex-col'>
                                    <div className='text-lg xl:text-3xl font-medium truncate tracking-wider'>Miscellaneous</div>
                                    <div className="flex space-x-2 flex-row text-sm tracking-widest leading-5">
