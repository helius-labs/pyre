...
export default function Tracks({ setSelectedComponent, progress, setTrack }: any) {
    ...
    return (
        <>
            ...
            <div className='flex w-full h-screen flex-row px-8 py-32 justify-evenly'>
            ...
            <div className='tracking-widest text-3xl'>
                ...
                <div onMouseOver={()=>{setSelected(3)}} onClick={()=>{setTrack("MISC")}} className={`flex w-[25%] border rounded-md items-center justify-center duration-200 cursor-pointer ${selected==3?"scale-110 border-orange-400 text-orange-400":"border-zinc-900"}`}>
                    <div className='tracking-widest text-3xl'>
                        MISC</div>
                </div>
            </div>
