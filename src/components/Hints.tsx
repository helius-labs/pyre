...
export default function Hints({ content }:any) {
    ...
    for (let i:any = 0; i<content.length; i++) {
        ...
        <div key={i} className="flex w-full flex-col bg-zinc-900 rounded-lg duration-200">
            <div className="flex w-full hover:bg-zinc-800 rounded-lg duration-200 cursor-pointer" onClick={() => {
